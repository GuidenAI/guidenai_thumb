...
const docsSimplePinkyLayoutConfig = z.object({
  Page: z.string(),
...
export type DocsSimplePinkyLayoutConfig = z.infer<typeof docsSimplePinkyLayoutConfig>;

const Component: React.FC<{ config: DocsSimplePinkyLayoutConfig & { isServerSide?: boolean } }> = ({ config }) => {
  const url =
    (config.Url ?? "").trim() === ""
      ? "guidenai.com"
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(245.93deg, #AD50EA 0%, #D72B82 36.63%)",
        }}
      />
      <div
        tw="absolute inset-0"
...
export const docsSimplePinkyLayout: ILayout<typeof docsSimplePinkyLayoutConfig> = {
  name: "docs-simple-pinky",
  config: docsSimplePinkyLayoutConfig,
  properties: [
    {
      type: "text",
      name: "Page",
